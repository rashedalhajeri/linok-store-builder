        ...
        <div className="flex gap-4 p-4">
          ...
          <div className="flex-1">
            <div className="flex justify-between items-start">
              ...
              <span className="font-bold text-primary text-lg bg-primary/5 px-3 py-1 rounded-full">
                {item.price}
              </span>
            </div>
            ...
            <div className="flex gap-2 mt-3">
              {item.isSpicy && (
                <Badge variant="secondary" className="bg-red-50 text-red-600 hover:bg-red-100 transition-colors duration-300">
                  حار 🌶️
                </Badge>
              )}
              {item.isPopular && (
                <Badge variant="secondary" className="bg-orange-50 text-orange-600 hover:bg-orange-100 transition-colors duration-300">
                  الأكثر طلباً ⭐️
                </Badge>
              )}
            </div>
