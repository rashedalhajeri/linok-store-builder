...
export const MenuItem = ({ item }: MenuItemProps) => {
  return (
    ...
    >
      <Card className="overflow-hidden hover:shadow-xl transition-all duration-300 group border-0 bg-gradient-to-b from-white/95 to-gray-50/95 backdrop-blur-sm">
