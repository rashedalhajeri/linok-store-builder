      ...
      <div className="relative">
        <div className="absolute top-4 left-4 z-10">
          <Button
            variant="outline"
            size="sm"
            className="rounded-full border border-gray-200 bg-white hover:bg-gray-50 active:bg-gray-50 text-gray-700 font-medium shadow-sm backdrop-blur-sm h-8 px-3"
