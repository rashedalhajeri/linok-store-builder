...
export const translations = {
  ...
  ar: {
    ...
    storeDescription: "كل ما أنت عليه. في مكان واحد",
    showMore: "عرض المزيد",
    showLess: "عرض أقل",
    location: "الموقع",
    allProducts: "الكل",
    ...
    storeSubDescription: "أنشئ وأدر حضورك الرقمي بأدوات قوية",
    or: "أو",
  ...
  es: {
    ...
    professionalTemplates: "Templates Profesionales",
    templatesDescription: "Variedad de templates listos para usar",
